            Feature: Desktop Checkout for Guest User
              ...
              Scenario: Order should contain appropriate totals
                ...
                Then order subtotal is displayed and equals "$99.85"
                And order total is displayed and equals "$99.85"
                And order tax is displayed and equals "Your order includes $4.75 tax."